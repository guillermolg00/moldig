...
Issues, wayfinder maps and specs for this repo live as markdown files in `.scratch/`.
...
- Research findings referenced by a ticket live in `docs/research/<NN>-<slug>.md` (this repo is not under git yet, so there are no `research/<name>` branches; the ticket links the file instead)
