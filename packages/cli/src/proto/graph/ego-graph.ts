 ...
 *
 * Pure ego-graph builder over index v0 (ticket 07). No terminal, no React: the
 * screen paints what this returns. Breadth-first over the five legend edge
 * kinds, one node per id (first reach wins), capped neighbourhood, the other
 * edge kinds hidden but counted.
 */
import type {
  AuditIndex,
  Confidence,
