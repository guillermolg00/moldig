// THROWAWAY PROTOTYPE (ticket 09) — cursor + window for a keyboard-driven list.
//
// The cursor is remembered by key so it survives filtering and re-sorting; the window is
// the slice of `height` items that keeps the cursor visible. Section rows are skipped.
